...
public:
	...
	/// Set 2 colors of the cells given cell ids (ids only include 0 or 1 value)
	void DisplayVerticesColors2(vtkIntArray* Ids, double* color1, double* color2);

	/// Set 3 colors of the cells given cell ids (ids only include 0 or 1 or 2 value)
	void DisplayVerticesColors3(vtkIntArray* Ids, double* color1, double* color2, double *color3);
	...
	bool GetConnectivityFlag();

	// set connectivity flag
	void SetConnectivityFlag(bool Changed);

	// get geometry flag
	bool GetGeometryFlag();

	// set geometry flag
	void SetGeometryFlag(bool Changed);

	// get modified vertices
	std::vector<vtkIdType> GetModifiedVertices();

	// add modified vertices
	void AddModifiedVertices(vtkIdType id);

	// clear modified vertices
	void ClearModifiedVertices();
...
protected:
	...
	// The flag used to check modification of connectivity of the input mesh
	bool isConnectivityChanged;

	// The flag used to check modification of geometry of the input mesh
	bool isGeometryChanged;

	// The ROI^S vertices for the highest level mesh
	std::vector<vtkIdType> ModifiedVertices;

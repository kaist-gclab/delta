...
Program:   Mailleur 3D multi-r?olution (Creatis 1997 ~)
...
public:
	...
	void RoiSetting();
	void RoiRandom(int k);
	void RoiIncrease(int k);
	void RoiLocal(int k);

	void SetInput2();
	void ExportOBJ(vtkSurface *Surface);
...
protected:
	...
	const char *InputFileName; // filepath + filename(no ext.)
	const char *FileName;
